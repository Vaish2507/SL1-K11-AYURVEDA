...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  <div style="background:#009970;padding: 14px 3px;color:white;font-size: 15pt;text-align: center;text-shadow: 1px 1px 11px black">
    <a href="index.php" style="color: white;text-decoration: none;">AYURVEDIC </a>
  </div>
  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        <a href="http://localhost/AYURVEDIC/index1.html"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Home</li></a>
...
<div class="marginLeft" >
  <div style="color:white;background:#009970" >
